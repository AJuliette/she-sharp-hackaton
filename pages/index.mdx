...
import {Autocomplete, Button, FormControl, Input, TextField} from '@mui/material'
...
export const revenue_ranges = ["Unknown", "<$1M", "$5-25M", "$25-50M", "$25-100M", "$100-500M", "$500M-$1B", "$1-5B", "$2-5B", "$5-10B", "$10B+"]
...
<FormControl>
  <form action="/api/form" method="post">
    ...
    Don't talk to me if your salary is not in this range:
    ...
    <Autocomplete
      ...
      sx={{ width: 300 }}
      renderInput={(params) => <TextField {...params} label="revenue" name="revenue_range" />}
    />
